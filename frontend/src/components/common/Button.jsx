// Dark-mode Button — balanced contrast colors for high readability
const VARIANTS = {
  ...
  danger:        "bg-red-500/15 text-red-400 border border-red-500/30 hover:bg-red-500/25 hover:border-red-500/50 shadow-sm",
